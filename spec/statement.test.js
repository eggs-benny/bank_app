...
describe('Statement', () => {
  ...
  beforeEach(() => {
    ...
    fakeDeposit = {date: '10/01/2023', deposit: 1000, withdrawal: 0, balance: 1000}
    fakeDeposit2 = {date: '13/01/2023', deposit: 2000, withdrawal: 0, balance: 3000}
    fakeWithdrawal = {date: '14/01/2023', deposit: 0, withdrawal: 500, balance: 2500}
  });
    ...
    describe('#print statement', () => {
      fit('prints statement with one deposit', () => {
      ...
      xit('prints statement with two deposits & a withdrawal', () => {
        statement.addTransaction(fakeDeposit)
        statement.addTransaction(fakeDeposit2)
        statement.addTransaction(withdrawal)
